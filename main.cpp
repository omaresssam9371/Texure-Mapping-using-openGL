...
static float yTable = 1.25;
static float zTable = 3.5;


// Chair Positions
static float xChair = 1.5;
static float yChair = 2;
static float zChair = -5;
...
// Objects instances
Model table((char*)"data/2DoorLowerCabinet.obj");        // table Model
Model ball((char*)"data/soccerball.obj");    // Ball Model
Model chair((char*)"data/sedia.obj");
...
int main(int argc, char** argv)
{
    ...
    glutCreateWindow("Full Robot with Animations");
...
void Choose_texture(int id)
{
    ...
    case 3:
        initRendering("data/ice.bmp", textureId);
        break;
